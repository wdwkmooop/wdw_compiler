...
在构建FA时会用的表示字符的类,
比如[a-z]可能会表示为'asdfghjklzxcvbnmqwertyuiop'
'''
class CharClass():
    def __init__(self,s):
        self.charset = s
...
class anychar(CharClass):
    def match(self,c):
        return c!='\n'


numbers = CharClass('0123456789')
letter = CharClass('asdfghjklzxcvbnmqwertyuiop')
